...
### Results ###
##### Parameters #####
# N: Total patients in the trial
# p: Success probabilities vector
# burn-in: Burn-in patients per arm
# nsim: Number of simulations
# method: RAR algorithm; for optimal proportion (OP), specify the proportion
# proportion: Proportion used for OP or NULL
